    ...
    <section className="mx-auto max-w-6xl px-4 py-12">
      ...
      <div ref={cedRef} className="reveal-right mb-16">
        ...
        <p className="mt-4 text-neutral-300 font-mono text-sm md:text-base leading-relaxed text-right">
          THROUGH A WIDE RANGE OF INITIATIVES, INCLUDING EVENTS LIKE THE STARTIFY CONCLAVE AND START-UP TAMIZH AND THE ESTABLISHMENT OF ENTREPRENEURIAL DEVELOPMENT CELLS (EDCs) WITHIN UNIVERSITY DEPARTMENTS, CED EMPOWERS STUDENTS TO EXPLORE AND DEVELOP THEIR BUSINESS IDEAS.
        </p>
        <p className="mt-4 text-neutral-300 font-mono text-sm md:text-base leading-relaxed text-right">
